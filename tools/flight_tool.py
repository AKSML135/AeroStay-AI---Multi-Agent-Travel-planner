...
DEFAULT_ORIGIN_IATA = 'KOL'
BASE_URL = "https://api.aviationstack.com/v1/flights"
AIRPORTS = airportsdata.load('IATA')

#country aliases that people use mapping to actual IATA code
COUNTRY_ALIASES = {
    "usa": "US",
    "u.s.a": "US",
    "u.s.": "US",
...
# airport IATA code for for main cities
CITY_MAIN_AIRPORT = {
    "delhi": "DEL",
    "new delhi": "DEL",
    "mumbai": "BOM",
...
#basic textprocessing, removing stop words
...
#will search for exact country in country aliases , fallback to pycountry to look for countries
#then it will search for country in longer text
...
# get main airport for each country code 
...
# get airport code for country/city
...
#Find country/city name in a sentence
...
def parse_route(query: str):
    ...
    KOL, NRT    -> filtered route
    KOL, None   -> all flights from KOL
